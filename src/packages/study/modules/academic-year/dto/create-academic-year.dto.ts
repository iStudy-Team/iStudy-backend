...
export const CreateAcademicYearSchema = z.object({
    school_year: z.string().min(1, 'School year is required').max(20, 'School year must not exceed 20 characters'),
    start_date: z
        .string()
        .optional()
        .refine(
...
export class CreateAcademicYearDto extends createZodDto(CreateAcademicYearSchema) {
    ...
    @ApiProperty({
        description: 'Status of the academic year (0 = INACTIVE, 1 = ACTIVE, 2 = COMPLETED)',
